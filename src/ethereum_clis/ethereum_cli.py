        ...
        for version_flag, subclasses in groupby(
            ...
            try:
                ...
                if result.returncode != 0:
                    ...
                    continue  # don't raise exception, you are supposed to keep
                              # trying different version flags  # noqa: E501
                ...
                if result.stdout:
                    ...
                    # e.g. 1.31.10+f62cfede9b4abfb5cd62d6f138240668620a2b0d
                    # should be treated as 1.31.10  # noqa: E501 if "+" in
                    # binary_output: binary_output =
                    # binary_output.split("+")[0]
