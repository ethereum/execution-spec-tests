...
def to_fixed_size_bytes(
    ...
    *,
    ...
    :param left_padding: Whether to allow left-padding of the input data bytes
        using zeros. If the input data is an integer, padding is always
        performed.
    :param right_padding: Whether to allow right-padding of the input data
        bytes using zeros. If the input data is an integer, padding is always
        performed.
    """
