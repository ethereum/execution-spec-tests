...
def hex_string(hex_string: str, assembly: bool):
    ...
    Example 1: Convert a hex string to EEST Python `Opcodes` uv run evm_bytes
    hex-string 604260005260206000F3

    Output 1:  Op.PUSH1[0x42] + Op.PUSH1[0x0] + Op.MSTORE + Op.PUSH1[0x20] +
    Op.PUSH1[0x0] + Op.RETURN

    Example 2: Convert a hex string to assembly uv run evm_bytes hex-string
    --assembly 604260005260206000F3
...
def binary_file(binary_file, assembly: bool):
    ...
    Example: Convert the Withdrawal Request contract to assembly  uv run
    evm_bytes binary-file
    ./src/ethereum_test_forks/forks/contracts/withdrawal_request.bin --assembly

    Output:  caller push20 0xfffffffffffffffffffffffffffffffffffffffe eq push1
    0x90 jumpi ...
    """  # noqa: E501,D301
