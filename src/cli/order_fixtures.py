...
def recursive_sort(item: Dict[str, Any] | List[Any]) -> Dict[str, Any] | List[Any]:
    ...
    Args: item: The item to be sorted. This can be a list or a dictionary.
...
def order_fixture(input_path: Path, output_path: Path) -> None:
    ...
    Args: input_path: The Path object of the input .json file. output_path: The
    Path object of the output .json file.
