...
Classes: - RequestManager: The main class for managing RPC requests and
responses. - RemoteTransaction: A Pydantic model representing a transaction
retrieved from the node. - RemoteBlock: A Pydantic model representing a block
