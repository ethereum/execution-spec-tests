...
class WitnessCheck:
    ...
    def add_account_codehash(
        ...
        self.witness_check[
            self._account_key(
                address,
                WitnessCheck.AccountHeaderEntry.CODEHASH,
                # t8n,
            )
        ] = codehash
