"""
Pytest plugin to create a temporary folder for the session where multi-
process tests can store data that is shared between processes.
...
def session_temp_folder_name(testrun_uid: str) -> str:
    """
    Define the name of the temporary folder that will be shared among all
    the xdist workers to coordinate the tests.
