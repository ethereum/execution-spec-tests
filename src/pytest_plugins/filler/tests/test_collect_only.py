...
def test_collect_only_output(testdir):
    ...
    # fill generates 4 test variants: state_test, blockchain_test_from_state_test,
    # blockchain_test_engine_from_state_test, and blockchain_test_engine_reorg_from_state_test
    assert "4 tests collected" in result.output
