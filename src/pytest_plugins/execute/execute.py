...
from ethereum_test_execution import EXECUTE_FORMATS, BaseExecute, ExecuteFormatWithPytestID
    ...
    for test_type in SPEC_TYPES:
        if test_type.pytest_parameter_name() in metafunc.fixturenames:
            ...
            for format_with_or_without_id in test_type.supported_execute_formats:
                if isinstance(format_with_or_without_id, ExecuteFormatWithPytestID):
                    parameters.append(
                        pytest.param(
