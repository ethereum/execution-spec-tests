...
[ethereum/execution-spec-tests](https://github.com/ethereum/execution-spec-tests) generates JSON test fixtures that can be consumed by execution clients directly or via the [Hive `pyspec` simulator](https://github.com/ethereum/hive/tree/master/simulators/ethereum/pyspec#readme):
...
The execution-spec-tests repository provide releases for:

- Fixtures specific for Hive / client consumption.
- Deployed forks only / All forks, including features for development forks.

As of 2023-10-16:

| Release Artifact Basename      | Consumer | Fork/feature scope |
| ------------------------------ | -------- | ------------------ |
...
The following script demonstrates how to obtain the most recent release version of a specific artifact:
