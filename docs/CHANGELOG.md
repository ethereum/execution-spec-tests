...
- 🐞 Register generated test markers, e.g., `blockchain_test_from_state_test`, to prevent test session warnings ([#1245](https://github.com/ethereum/execution-spec-tests/pull/1245)).
