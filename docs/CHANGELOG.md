...
- ✨ Add the `eest make config` command that helps generate the default configuration file (env.yml)([#996](https://github.com/ethereum/execution-spec-tests/pull/996)).
