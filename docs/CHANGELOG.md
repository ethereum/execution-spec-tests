...
- 🔀 `blockHashes` keys of the `env` field in the object that is passed to the transition tool has been changed from a decimal number encoded as a string, to a hexadecimal number encoded as a string ([#1754](https://github.com/ethereum/execution-spec-tests/pull/1754)).
