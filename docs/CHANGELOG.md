...
- 🔀 [EIP-4844](https://eips.ethereum.org/EIPS/eip-4844): Update KZG point evaluation test vectors to use data from the official KZG setup ([#XXX](https://github.com/ethereum/execution-spec-tests/pull/XXX)).
