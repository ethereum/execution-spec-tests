...
- ✨ `StateTest` fixture format now contains `postDecoded` field in each network post result, containing the decoded post allocation that results from the transaction execution ([#1064](https://github.com/ethereum/execution-spec-tests/pull/1064)).
