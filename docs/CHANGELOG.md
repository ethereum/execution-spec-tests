...
- 🔀 Refactored RLP encoding of test objects to allow automatic generation of tests (to be implemented in a future PR) ([#1359](https://github.com/ethereum/execution-spec-tests/pull/1359))
