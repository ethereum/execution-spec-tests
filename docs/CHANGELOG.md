...
- ✨ Add the `et clean` command to help clean generated files and directories from the repository ([#980](https://github.com/ethereum/execution-spec-tests/pull/980)).
