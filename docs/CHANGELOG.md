...
- ✨ Added [`named_parametrize` decorator](https://ethereum.github.io/execution-spec-tests/main/writing_tests/writing_a_new_test/#named_parametrize-decorator), which can be used as a replacement to `@pytest.mark.parametrize` to limit the generated test combinations ([#739](https://github.com/ethereum/execution-spec-tests/pull/739)).
