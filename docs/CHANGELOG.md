...
- ✨ [EIP-7742: Uncouple blob count between CL and EL](https://eips.ethereum.org/EIPS/eip-7742) initial test cases ([#994](https://github.com/ethereum/execution-spec-tests/pull/994))
