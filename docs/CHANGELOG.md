...
- ✨ Run geth's `evm blocktest` command to verify JSON fixtures after test case execution with `--verify-fixtures` ([#325](https://github.com/ethereum/execution-spec-tests/pull/325)).
