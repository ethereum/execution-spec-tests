...
3. Generate (fill) `state_test` fixtures for these test cases:
    ...
    This generated test fixtures that can be executed against execution clients using the [Ethereum Execution Layer Specification](https://github.com/ethereum/execution-specs) (EELS) reference implementation.
