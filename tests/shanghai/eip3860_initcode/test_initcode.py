...
class TestCreateInitcode:
    ...
    @pytest.fixture
    def creator_code(self, opcode: Op, create2_salt: int) -> Code:
        """
    ...
    @pytest.fixture
    def creator_contract_address(self, pre: Alloc, creator_code: Code) -> Address:
        """
    ...
    @pytest.fixture
    def caller_code(self, creator_contract_address: Address) -> Code:
        """
        Generates the code for the caller contract that calls the creator contract.
        """
        return Code(
            Op.CALLDATACOPY(0, 0, Op.CALLDATASIZE)
            + Op.SSTORE(Op.CALL(5000000, creator_contract_address, 0, 0, Op.CALLDATASIZE, 0, 0), 1)
        )

    @pytest.fixture
    def caller_contract_address(self, pre: Alloc, caller_code: Code) -> Address:
        """
