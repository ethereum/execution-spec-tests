...
from ethereum_test_tools import Initcode, ceiling_division
...
def calculate_create_tx_intrinsic_cost(fork: Fork, initcode: Initcode) -> int:
    """
    ...
    return (
        ...
        + calldata_gas_calculator(data=initcode)  # Transaction calldata cost
...
def calculate_create_tx_execution_cost(
    ...
    """
    cost = calculate_create_tx_intrinsic_cost(fork, initcode)
