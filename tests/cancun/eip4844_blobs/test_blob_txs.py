"""
abstract: Tests blob type transactions for [EIP-4844: Shard Blob
Transactions](https://eips.ethereum.org/EIPS/eip-4844) Test blob type
transactions for [EIP-4844: Shard Blob
...
- blockchain_test or state_test - pre - env - block or txs
...
@pytest.mark.parametrize("tx_max_priority_fee_per_gas", [0, 2])  # always below
                                                                 # data fee
@pytest.mark.parametrize("tx_max_fee_per_blob_gas_delta", [0, 1])  # normal and
                                                                   # above
                                                                   # priority
                                                                   # fee
@pytest.mark.parametrize("tx_max_fee_per_gas", [100])  # always above priority
                                                       # fee (FOR CANCUN)
