...
Transactions](https://eips.ethereum.org/EIPS/eip-4844) Test cases for the
`BLOBHASH` opcode in [EIP-4844: Shard Blob
...
- blockchain_test - pre - tx - post

Additional custom `pytest.fixture` fixtures can be added and parametrized for
new test cases.
