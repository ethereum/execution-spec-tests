...
def test_worst_modarith(
    ...
    mod[0] = calldataload(0)
    mod[1] = (args[indexes[0]] op fixed_arg) % mod[0]
    mod[2] = (args[indexes[1]] op fixed_arg) % mod[1]
    ...
    # Construct the final code. Because of the usege of PUSH32 the code segment is very long,
