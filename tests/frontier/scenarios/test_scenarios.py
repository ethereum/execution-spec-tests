...
@pytest.mark.parametrize(
    # select program to debug ("program_id","scenario_name") program="" select
    # all programs scenario_name="" select all scenarios Example:
    # [ScenarioDebug(program_id=ProgramSstoreSload().id,
    # scenario_name="scenario_CALL_CALL")],  # noqa: E501
    "debug",
    [
        ScenarioDebug(
            program_id="",
