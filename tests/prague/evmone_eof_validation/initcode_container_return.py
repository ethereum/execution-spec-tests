...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
                ...
                "0xef0001010004020001000b030001001804000000008000046000600060006000ec0000ef00010100040200010005040000000080000260006000f3",
                EOFException.INCOMPATIBLE_CONTAINER_KIND,
                id="initcode_container_return_2",
            ),
