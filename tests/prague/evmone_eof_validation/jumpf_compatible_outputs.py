        ...
        pytest.param(
                Container(
                    ...
                    sections=[
						...
						Section.Code(code=Op.PUSH0 * 2 + Op.JUMPF[0x0002], code_outputs=5, max_stack_height=2),
						Section.Code(code=Op.PUSH0 * 3 + Op.RETF, code_outputs=3, max_stack_height=3),
                    ],
                    kind=ContainerKind.RUNTIME,
                ),
                "0xef000101000c02000300040005000404000000008000050005000200030003e30001005f5fe500025f5f5fe4",
                None,
                id="jumpf_compatible_outputs_1",
            ),
