    ...
    [
        pytest.param(
            ...
            Container(
                ...
                id="unknown_section_05_after_code",
            ),
            pytest.param(
            Container(
                name="EOF1V00004",
                ...
                EOFException.MISSING_DATA_SECTION,
                id="unknown_section_ff_after_code",
            ),
            pytest.param(
            Container(
                name="EOF1V00005",
                ...
                id="unknown_section_05_after_data",
            ),
            pytest.param(
            Container(
                name="EOF1V00006",
                ...
                EOFException.MISSING_TERMINATOR,
                id="unknown_section_ff_after_data",
            ),
    ]
)
