...
class DepositRequest(DepositRequestBase):
    ...
    If this value modulo 10**9 is not zero, the deposit will be invalid. The
    value can be negative but if the total value is negative, an exception will
    be raised.
    """
    ...
    def calldata(self) -> bytes:
        ...
        deposit(     bytes calldata pubkey,     bytes calldata
        withdrawal_credentials,     bytes calldata signature,     bytes32
        deposit_data_root )
        """
        offset_length = 32
