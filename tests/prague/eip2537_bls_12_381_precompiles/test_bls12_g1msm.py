"""
abstract: Tests BLS12_G1MSM precompile of [EIP-2537: Precompile for BLS12-381
curve operations](https://eips.ethereum.org/EIPS/eip-2537) Tests BLS12_G1MSM
precompile of [EIP-2537: Precompile for BLS12-381 curve
...
@pytest.mark.parametrize(
    ...
    + [
        ...
        pytest.param(
            Spec.G1 + Scalar(1).x.to_bytes(16, byteorder="big"),  # Invalid
                                                                  # scalar
                                                                  # length
            id="scalar_too_short",
        ),
