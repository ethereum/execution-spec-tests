...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
              ...
              ,
              "ef000101000402000100060300010014040000000080000260006000ee00ef000101000402000100010400000000800000fe",
              EOFException.INCOMPATIBLE_CONTAINER_KIND,
              id="runtime_container_returncontract_0"
        ),
        pytest.param(
              Container(
                name = 'EOFV1_0002',
              ...
              ,
              "ef000101000402000100060300010032040000000080000260006000ee00ef000101000402000100060300010014040000000080000260006000ee00ef000101000402000100010400000000800000fe",
              EOFException.INCOMPATIBLE_CONTAINER_KIND,
        ...
        pytest.param(
                ...
                sections = [
                    ...
                    Section.Container(container=Container(
                        ...
                        sections = [
                            Section.Code(code=Op.PUSH1[0] * 2 + Op.RETURNCONTRACT[0], max_stack_height=2),
                            Section.Container(container=Container(
                                name = 'EOFV1_0003_D2I0',
                                sections = [
                                    Section.Code(code=Op.PUSH1[0] * 2 + Op.RETURNCONTRACT[0], max_stack_height=2),
                                    Section.Container(container=Container(
                                        name = 'EOFV1_0003_D3I0',
                                        sections = [
                                            Section.Code(code=Op.INVALID, max_stack_height=0),
                                            ],
                                      )
              ...
              ,
              "ef0001010004020001000b030001005004000000008000046000600060006000ec0000ef000101000402000100060300010032040000000080000260006000ee00ef000101000402000100060300010014040000000080000260006000ee00ef000101000402000100010400000000800000fe",
              EOFException.INCOMPATIBLE_CONTAINER_KIND,
