    ...
    calling_storage = Storage(
        {
            ...
            slot_call_result: value_legacy_call_worked,
        }
    )
    ...
    pre = {
        ...
        destination_contract_address: Account(
            code=Container(
                sections=[
                    Section.Code(
                        code=Op.MSTORE8(0, value_returndata_magic) + Op.RETURN(0, 1),
                        code_outputs=NON_RETURNING_SECTION,
                        max_stack_height=2,
                    )
                ]
...
def test_eof_calls_eof_sstore(
    ...
    calling_storage = Storage(
        {
            slot_code_worked: value_code_worked,
            slot_call_result: value_eof_call_worked,
        }
    )
    destination_storage = Storage()
...
def test_eof_calls_eof_mstore(
    ...
    pre = {
        ...
        destination_contract_address: Account(
            code=Container(
                sections=[
                    Section.Code(
                        code=Op.MSTORE8(0, value_returndata_magic) + Op.RETURN(0, 32),
                        code_outputs=NON_RETURNING_SECTION,
                        max_stack_height=2,
                    )
                ]
    ...
    calling_storage = {
        slot_code_worked: value_code_worked,
        slot_call_result: value_eof_call_worked,
        slot_returndata: value_returndata_magic * 2**248,
    }
