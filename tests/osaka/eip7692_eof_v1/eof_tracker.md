...
- [x] Max allowed stack height reached in JUMPF-ed function. JUMPF in variable stack segment. ([`tests/osaka/eip7692_eof_v1/eip6206_jumpf/test_jumpf_stack.py::test_jumpf_stack_overflow_variable_stack_2`](./eip6206_jumpf/test_jumpf_stack/test_jumpf_stack_overflow_variable_stack_2.md))
- [x] JUMPF validation time stack overflow in variable stack segment - only max overflow. ([`tests/osaka/eip7692_eof_v1/eip6206_jumpf/test_jumpf_stack.py::test_jumpf_stack_overflow_variable_stack_2`](./eip6206_jumpf/test_jumpf_stack/test_jumpf_stack_overflow_variable_stack_2.md))
- [x] JUMPF validation time stack overflow in variable stack segment - both min and max overflow. ([`tests/osaka/eip7692_eof_v1/eip6206_jumpf/test_jumpf_stack.py::test_jumpf_stack_overflow_variable_stack_2`](./eip6206_jumpf/test_jumpf_stack/test_jumpf_stack_overflow_variable_stack_2.md))
