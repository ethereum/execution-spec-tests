...
@pytest.mark.parametrize(
    ...
    [
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[0] * 4 + Op.EOFCREATE[0] + Op.PUSH1[0] *
                    2 + Op.RETURNCONTRACT[0],
                    max_stack_height=4),
            ...
            expected_bytecode="ef00010100040200010010030001001404000000008000046000600060006000ec0060006000ee00ef000101000402000100010400000000800000fe",
            validity_error=[
                EOFException.AMBIGUOUS_CONTAINER_KIND
            ],
        ),
        Container(
            name="ambiguous_container_kind_1",
            sections=[
                Section.Code(code=Op.PUSH1[0] * 4 + Op.EOFCREATE[0] + Op.PUSH1[0] *
                    2 + Op.RETURNCONTRACT[0],
                    max_stack_height=4),
                Section.Container(container=Container(
                    name="ambiguous_container_kind_1_D1I0",
                    sections=[
                        Section.Code(code=Op.INVALID,
                            max_stack_height=0),
                    ],
                ...
                Section.Container(container=Container(
                    name="ambiguous_container_kind_1_D1I1",
                    sections=[
                        Section.Code(code=Op.INVALID,
                            max_stack_height=0),
                    ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[0] * 4 + Op.EOFCREATE[0] + Op.STOP,
                    max_stack_height=4),
                Section.Container(container=Container(
                    name="eofcreate_return_and_returncontract_0_D1I0",
                    sections=[
                        Section.Code(code=Op.PUSH1[0] + Op.RJUMPI[5] + Op.PUSH1[0] * 2 +
                            Op.RETURN + Op.PUSH1[0] * 2 +
                            Op.RETURNCONTRACT[0],
                            max_stack_height=2),
                        Section.Container(container=Container(
        ...
        Container(
            ...
            sections=[
                ...
                Section.Container(container=Container(
                    ...
                    sections=[
                        Section.Code(code=Op.PUSH1[0] + Op.RJUMPI[1] + Op.STOP + Op.PUSH1[0] *
                            2 + Op.RETURNCONTRACT[0],
                            max_stack_height=2),
                        Section.Container(container=Container(
