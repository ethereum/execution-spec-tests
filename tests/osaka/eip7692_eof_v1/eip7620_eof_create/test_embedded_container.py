...
@pytest.mark.parametrize(
    ...
    [
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[2] + Op.PUSH1[0] +
                    Op.RETURNCONTRACT[0],
                    max_stack_height=2),
                Section.Container(
                    container=Container(
                            ...
                            [
                                ...
                                0x04, 0x00, 0x02, # Data Length: 2
                                      ...
                                      0x00, 0x00, #   Max Stack Height: 0
                                                  # Code Section 0
                                            0xFE, #  [0] INVALID
                                                  # Empty Data Section (Truncated: 0 != 2)
                            ]
                        ),
                    )
              ),
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[1] + Op.PUSH1[0] +
                    Op.RETURNCONTRACT[0],
                    max_stack_height=2),
                Section.Container(
                    container=Container(
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[0] * 4 + Op.EOFCREATE[0] + Op.POP + Op.PUSH1[0] *
                    4 + Op.EOFCREATE[1] + Op.STOP,
                    max_stack_height=4),
                Section.Container(container=Container(
                ...
                Section.Container(container=Container(
                    ...
                    sections=[
                        Section.Code(code=Op.PUSH1[0] * 2 + Op.REVERT,
                            max_stack_height=2),
                    ],
                  )
                ),
