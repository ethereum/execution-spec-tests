...
@pytest.mark.parametrize(
    ...
    [
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 33 + Op.EXCHANGE[255] + Op.STOP, max_stack_height=33
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[0] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[16] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[1] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[32] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[2] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[112] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[7] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[17] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[52] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[67] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[22] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[97] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[128] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[8] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[113] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[23] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[68] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[83] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[53] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[238] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[239] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[254] + Op.STOP, max_stack_height=10
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[1] * 10 + Op.EXCHANGE[255] + Op.STOP, max_stack_height=10
                ),
            ],
