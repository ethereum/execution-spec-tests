...
@pytest.mark.parametrize(
    ...
    [
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[0] + Op.RJUMPI[-3] + Op.STOP,
                    max_stack_height=0),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[0] + Op.RJUMPV[-4] + Op.STOP,
                    max_stack_height=0),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    2 + Op.PUSH1[0] + Op.RJUMPI[-3] + Op.STOP,
                    max_stack_height=4),
            ],
        ...
        Container(
            name="self_referencing_jumps_variable_stack_2",
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    2 + Op.PUSH1[0] + Op.RJUMPV[-4] + Op.STOP,
                    max_stack_height=4),
            ],
