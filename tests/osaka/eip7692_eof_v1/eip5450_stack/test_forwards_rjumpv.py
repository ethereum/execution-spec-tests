...
@pytest.mark.parametrize(
    ...
    [
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[1] + Op.RJUMPV[0] + Op.STOP,
                    max_stack_height=1),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPV[1] + Op.NOT +
                    Op.STOP,
                    max_stack_height=2),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPV[2,3] +
                    Op.PUSH0 + Op.POP + Op.NOT + Op.STOP,
                    max_stack_height=2),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPV[1] +
                    Op.PUSH0 + Op.STOP,
                    max_stack_height=2),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPV[1,2] + Op.PUSH0 *
                    2 + Op.NOT + Op.STOP,
                    max_stack_height=3),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPV[5,10] +
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPV[4,9] +
                    Op.PUSH0 + Op.RJUMP[8] + Op.PUSH0 * 2 +
                    Op.RJUMP[3] + Op.PUSH0 * 3 + Op.STOP,
                    max_stack_height=4),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 * 4 + Op.PUSH1[0] + Op.RJUMPV[4,9] +
                    Op.POP + Op.RJUMP[8] + Op.POP * 2 +
                    Op.RJUMP[3] + Op.POP * 3 + Op.STOP,
                    max_stack_height=5),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPV[3] +
                    Op.RJUMP[0] + Op.STOP,
                    max_stack_height=2),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPV[4] +
                    Op.PUSH0 + Op.RJUMP[0] + Op.STOP,
                    max_stack_height=2),
            ],
...
def test_forwards_rjumpv(
    eof_test: EOFTestFiller,
    container: Container,
):
    """Test forwards RJUMPV."""
    eof_test(
        container=container,
