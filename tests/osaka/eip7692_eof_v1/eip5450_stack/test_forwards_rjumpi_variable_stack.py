...
@pytest.mark.parametrize(
    ...
    [
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    2 + Op.PUSH1[1] + Op.RJUMPI[0] + Op.STOP,
                    max_stack_height=4),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    3 + Op.PUSH1[0] + Op.RJUMPI[1] + Op.NOT +
                    Op.STOP,
                    max_stack_height=5),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    3 + Op.PUSH1[0] + Op.RJUMPI[6] + Op.PUSH1[0] +
                    Op.RJUMPI[1] + Op.NOT + Op.STOP,
                    max_stack_height=5),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    3 + Op.PUSH1[0] + Op.RJUMPI[1] + Op.PUSH0 +
                    Op.STOP,
                    max_stack_height=5),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    3 + Op.PUSH1[0] + Op.RJUMPI[7] + Op.PUSH0 +
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    3 + Op.PUSH1[0] + Op.RJUMPI[4] + Op.PUSH0 +
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    3 + Op.PUSH1[0] + Op.RJUMPI[4] + Op.POP +
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    3 + Op.PUSH1[0] + Op.RJUMPI[3] + Op.RJUMP[0] +
                    Op.STOP,
                    max_stack_height=5),
            ],
