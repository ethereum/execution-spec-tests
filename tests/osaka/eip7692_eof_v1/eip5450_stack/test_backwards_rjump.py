...
@pytest.mark.parametrize(
    ...
    [
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.POP + Op.RJUMP[-5],
                    max_stack_height=1),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.POP + Op.PUSH1[1] + Op.RJUMPI[3] +
                    Op.RJUMP[-8] + Op.RJUMP[-11],
                    max_stack_height=1),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.POP + Op.PUSH1[1] + Op.RJUMPI[3] +
                    Op.RJUMP[-8] + Op.PUSH0 + Op.RJUMP[-12],
                    max_stack_height=1),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.RJUMP[-4],
                    max_stack_height=1),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.POP + Op.RJUMP[-4],
                    max_stack_height=1),
            ],
