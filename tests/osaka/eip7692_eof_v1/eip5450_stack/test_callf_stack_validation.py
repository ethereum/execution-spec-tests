    ...
    [
        Container(
            ...
            sections=[
                ...
                Section.Code(
                    code=Op.PUSH0 * 2 + Op.CALLF[2] + Op.RETF, code_outputs=1, max_stack_height=2
                ),
                Section.Code(
                    code=Op.POP + Op.RETF, code_inputs=2, code_outputs=1, max_stack_height=2
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.CALLF[1] + Op.STOP, max_stack_height=1),
                Section.Code(
                    code=Op.PUSH0 * 3 + Op.CALLF[2] + Op.RETF, code_outputs=1, max_stack_height=3
                ),
                Section.Code(
                    code=Op.POP + Op.RETF, code_inputs=2, code_outputs=1, max_stack_height=2
                ),
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.CALLF[1] + Op.STOP, max_stack_height=1),
                Section.Code(
                    code=Op.PUSH0 + Op.CALLF[2] + Op.RETF, code_outputs=1, max_stack_height=1
                ),
                Section.Code(
                    code=Op.POP + Op.RETF, code_inputs=2, code_outputs=1, max_stack_height=2
                ),
