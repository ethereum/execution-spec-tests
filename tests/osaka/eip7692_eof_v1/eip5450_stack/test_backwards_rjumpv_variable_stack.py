...
@pytest.mark.parametrize(
    ...
    [
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    2 + Op.PUSH1[0] + Op.RJUMPV[-6] + Op.STOP,
                    max_stack_height=4),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    3 + Op.POP + Op.PUSH1[0] + Op.RJUMPV[-8] +
                    Op.STOP,
                    max_stack_height=4),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    3 + Op.POP + Op.PUSH1[0] + Op.RJUMPV[-8] +
                    Op.PUSH1[0] + Op.RJUMPV[-14] + Op.STOP,
                    max_stack_height=4),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    3 + Op.POP + Op.PUSH1[0] + Op.RJUMPV[-8] +
                    Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPV[-15] +
                    Op.STOP,
                    max_stack_height=5),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    ...
                    Op.PUSH1[0] + Op.RJUMPV[-12] + Op.STOP,
                    max_stack_height=5),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    4 + Op.PUSH1[0] + Op.RJUMPI[1] + Op.POP +
                    Op.PUSH1[0] + Op.RJUMPV[-12] + Op.STOP,
                    max_stack_height=5),
            ],
