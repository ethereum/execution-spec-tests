...
@pytest.mark.parametrize(
    ...
    [
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.RJUMPI[7] + Op.PUSH0 * 3 +
                    Op.RJUMPI[1] + Op.POP + Op.PUSH0 * 2 +
                    Op.REVERT,
                    max_stack_height=4),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 * 2 + Op.RJUMPI[7] + Op.PUSH0 * 3 +
                    Op.RJUMPI[1] + Op.POP + Op.PUSH0 * 2 +
                    Op.REVERT,
                    max_stack_height=5),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.RJUMPI[7] + Op.PUSH0 * 3 +
                    Op.RJUMPI[1] + Op.POP * 2 + Op.PUSH0 * 2 +
                    Op.REVERT,
                    max_stack_height=4),
            ],
