    ...
    [
        ...
        Container(
            ...
            sections=[
                ...
                Section.Code(
                    code=Op.PUSH0 + Op.RETF, code_inputs=1, code_outputs=2, max_stack_height=2
                ),
            ],
        ...
        Container(
            ...
            sections=[
                ...
                Section.Code(
                    code=Op.PUSH0 + Op.RETF, code_inputs=4, code_outputs=5, max_stack_height=5
                ),
            ],
        ...
        Container(
            ...
            sections=[
                ...
                Section.Code(
                    code=Op.PUSH0 + Op.RETF, code_inputs=3, code_outputs=4, max_stack_height=4
                ),
            ],
        ...
        Container(
            ...
            sections=[
                ...
                Section.Code(
                    code=Op.POP * 2 + Op.RETF, code_inputs=5, code_outputs=3, max_stack_height=3
                ),
            ],
