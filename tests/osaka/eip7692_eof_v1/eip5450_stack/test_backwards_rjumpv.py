...
@pytest.mark.parametrize(
    ...
    [
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[0] + Op.RJUMPV[-6] + Op.STOP,
                    max_stack_height=1),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.POP + Op.PUSH1[0] +
                    Op.RJUMPV[-8] + Op.PUSH1[0] + Op.RJUMPV[-14] +
                    Op.STOP,
                    max_stack_height=1),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.POP + Op.PUSH1[0] +
                    Op.RJUMPV[-8] + Op.PUSH0 + Op.PUSH1[0] +
                    Op.RJUMPV[-15] + Op.STOP,
                    max_stack_height=2),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.POP + Op.PUSH1[0] +
                    Op.RJUMPV[-8] + Op.PUSH0 + Op.RJUMP[-12],
                    max_stack_height=1),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[1] +
                    Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPV[-12] +
                    Op.STOP,
                    max_stack_height=3),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[190] + Op.PUSH1[0] + Op.RJUMPI[1] +
                    Op.POP + Op.PUSH1[0] + Op.RJUMPV[-12] +
                    Op.STOP,
                    max_stack_height=3),
            ],
