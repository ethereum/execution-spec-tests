...
@pytest.mark.parametrize(
    ...
    [
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[1] * 20 + Op.DUPN[0] + Op.STOP,
                    max_stack_height=21),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[1] * 20 + Op.DUPN[19] + Op.STOP,
                    max_stack_height=21),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[1] * 20 + Op.DUPN[20] + Op.STOP,
                    max_stack_height=21),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[1] * 20 + Op.DUPN[208] + Op.STOP,
                    max_stack_height=21),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[1] * 20 + Op.DUPN[254] + Op.STOP,
                    max_stack_height=21),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[1] * 20 + Op.DUPN[255] + Op.STOP,
                    max_stack_height=21),
            ],
