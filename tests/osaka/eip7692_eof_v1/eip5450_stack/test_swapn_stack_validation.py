...
@pytest.mark.parametrize(
    ...
    [
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[1] * 20 + Op.SWAPN[0] + Op.STOP,
                    max_stack_height=20),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[1] * 20 + Op.SWAPN[18] + Op.STOP,
                    max_stack_height=20),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[1] * 20 + Op.SWAPN[19] + Op.STOP,
                    max_stack_height=20),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[1] * 20 + Op.SWAPN[208] + Op.STOP,
                    max_stack_height=20),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[1] * 20 + Op.SWAPN[254] + Op.STOP,
                    max_stack_height=20),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH1[1] * 20 + Op.SWAPN[255] + Op.STOP,
                    max_stack_height=20),
            ],
