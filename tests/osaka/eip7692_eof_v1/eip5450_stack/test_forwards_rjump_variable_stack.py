...
@pytest.mark.parametrize(
    ...
    [
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    3 + Op.PUSH1[0] + Op.RJUMPI[3] + Op.RJUMP[1] +
                    Op.NOT + Op.STOP,
                    max_stack_height=5),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    3 + Op.PUSH1[0] + Op.RJUMPI[8] + Op.PUSH1[0] +
                    Op.RJUMPI[6] + Op.RJUMP[4] + Op.RJUMP[1] +
                    Op.NOT + Op.STOP,
                    max_stack_height=5),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.PUSH1[0] + Op.RJUMPI[2] + Op.PUSH0 *
                    2 + Op.PUSH1[0] + Op.RJUMPI[8] + Op.PUSH1[0] +
                    Op.RJUMPI[7] + Op.RJUMP[5] + Op.PUSH0 +
