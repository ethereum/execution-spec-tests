    ...
    [
        Container(
            ...
            sections=[
                ...
                Section.Code(
                    code=Op.PUSH0 + Op.RETF, code_inputs=5, code_outputs=3, max_stack_height=3
                ),
            ],
        ...
        Container(
            ...
            sections=[
                ...
                Section.Code(
                    code=Op.PUSH0 * 2 + Op.RETF, code_inputs=1, code_outputs=3, max_stack_height=5
                ),
            ],
        ...
        Container(
            ...
            sections=[
                ...
                Section.Code(
                    code=Op.POP * 4 + Op.RETF, code_inputs=5, code_outputs=1, max_stack_height=5
                ),
            ],
        ...
        Container(
            ...
            sections=[
                ...
                Section.Code(
                    code=Op.POP * 2 + Op.RETF, code_inputs=3, code_outputs=1, max_stack_height=3
                ),
            ],
