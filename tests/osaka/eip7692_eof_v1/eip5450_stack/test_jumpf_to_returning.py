    ...
    [
        Container(
            ...
            sections=[
                ...
                Section.Code(code=Op.JUMPF[2],
                    code_outputs=2,
                    max_stack_height=0),
                Section.Code(code=Op.PUSH0 * 2 + Op.RETF,
                    code_outputs=2,
                    max_stack_height=2),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.CALLF[1] + Op.STOP,
                    max_stack_height=2),
                Section.Code(code=Op.PUSH0 * 2 + Op.JUMPF[2],
                    code_outputs=2,
                    max_stack_height=2),
                Section.Code(code=Op.PUSH0 * 2 + Op.RETF,
                    code_outputs=2,
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.CALLF[1] + Op.STOP,
                    max_stack_height=2),
                Section.Code(code=Op.PUSH0 * 3 + Op.JUMPF[2],
                    code_outputs=2,
                    max_stack_height=3),
                Section.Code(code=Op.POP + Op.RETF,
                    code_inputs=3,
                    code_outputs=2,
                    max_stack_height=3),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.CALLF[1] + Op.STOP,
                    max_stack_height=2),
                Section.Code(code=Op.PUSH0 * 4 + Op.JUMPF[2],
                    code_outputs=2,
                    max_stack_height=4),
                Section.Code(code=Op.POP + Op.RETF,
                    code_inputs=3,
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.CALLF[1] + Op.STOP,
                    max_stack_height=2),
                Section.Code(code=Op.PUSH0 + Op.JUMPF[2],
                    code_outputs=2,
                    max_stack_height=1),
                Section.Code(code=Op.PUSH0 + Op.RETF,
                    code_outputs=1,
                    max_stack_height=1),
            ],
        ...
        Container(
            ...
            sections=[
                ...
                Section.Code(code=Op.PUSH0 * 4 + Op.JUMPF[2],
                    code_outputs=2,
                    max_stack_height=4),
                Section.Code(code=Op.POP * 2 + Op.RETF,
                    code_inputs=3,
                    code_outputs=1,
                    max_stack_height=3),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.CALLF[1] + Op.STOP,
                    max_stack_height=2),
                Section.Code(code=Op.PUSH0 * 5 + Op.JUMPF[2],
                    code_outputs=2,
                    max_stack_height=5),
                Section.Code(code=Op.POP * 2 + Op.RETF,
                    code_inputs=3,
