...
VALID: List[Container] = [
        Container(
            ...
            sections=[
                Section.Code(code=Op.DATALOADN[0] + Op.POP + Op.STOP,
                    max_stack_height=1),
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.DATALOADN[1] + Op.POP + Op.STOP,
                    max_stack_height=1),
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.DATALOADN[32] + Op.POP + Op.STOP,
                    max_stack_height=1),
