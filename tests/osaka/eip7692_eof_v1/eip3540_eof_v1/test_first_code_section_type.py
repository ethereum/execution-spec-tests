...
@pytest.mark.parametrize(
    ...
    [
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.RETF, code_outputs=0, max_stack_height=0),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.RETF, code_outputs=127, max_stack_height=0),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.RETF, code_outputs=129, max_stack_height=0),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.PUSH0 + Op.RETF, code_outputs=255, max_stack_height=0),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(
                    code=Op.PUSH1[0] + Op.TLOAD, code_inputs=2, code_outputs=3, max_stack_height=0
                ),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.POP + Op.RETF, code_inputs=128, max_stack_height=0),
            ],
        ...
        Container(
            ...
            sections=[
                Section.Code(code=Op.POP + Op.RETF, code_inputs=255, max_stack_height=0),
            ],
