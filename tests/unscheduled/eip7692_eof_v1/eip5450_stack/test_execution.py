...
def test_execution_at_max_stack_height(
    ...
    EOF doesn't allow to increase the stack height of a single code section
    more than 1023. The effect of the maximum runtime stack height is achieved
    by using non-zero number of the code section inputs and increasing the
    runtime stack to the limit accordingly. The test pushes consecutive numbers
